...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <table class="table table-bordered" id="" width="100%" cellspacing="0">
            <thead>
                <tr>
                    <th>Nama Dosen Berprestasi</th>
                    <th>Keaktifan Di Kampus</th>
                    <th>Prestasi Dan Penghargaan</th>
                    <th>Kinerja Pengjaran</th>
                    <th>Penelitian Dan Publikasi</th>
                </tr>
            </thead>
            <tbody>
                <tr>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h5 class="m-0 font-weight-bold text-primary">Hasil Pemilihan Dosen Berprestasi</h5>
    </div>
    <div class="card-body">
        <table class="table table-bordered" id="" width="100%" cellspacing="0">
            <thead>
