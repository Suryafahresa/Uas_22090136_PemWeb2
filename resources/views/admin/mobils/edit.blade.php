        ...
        <div class="card-body">
            <form action="{{ route('mobils.update', $mobil->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="nopol">Nama Dosen</label>
                    <input type="text" name="name" class="form-control" placeholder="Masukan id dosen"
                        value="{{ old('nama', $nama->nama) }}" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="slug">Prestasi</label>
                    <input type="text" name="prestasi" class="form-control" placeholder="Masukan slug mobil"
                        value="{{ old('slug', $mobil->slug) }}" />
                </div>
                <div class="form-group">
                    <label for="gambar">Tahun</label>
                    <img src="{{url('/storage/'.$mobil->gambar)}}" width="100" alt="">
                    <input type="file" name="tahun" class="form-control" />
                </div>
                <div class="form-group">
                    <label for="harga">Email</label>
                    <input type="number" name="email" class="form-control" placeholder="Masukan harga mobil"
                        value="{{ old('harga',$mobil->harga) }}" />
                </div>
                <div class="form-group">
                    <label for="tahun">Nomer Telepon</label>
                    <input type="number" name="nomer telepon" class="form-control" placeholder="Masukan tahun"
                        value="{{ old('tahun', $mobil->tahun) }}" />
                </div>
                <div class="form-group">
                    <label for="merek">Publikasi Terkini</label>
                    <input type="text" name="publikasi terkini" class="form-control" placeholder="Masukan merek"
