...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('homepage')}}">
        <div class="sidebar-brand-icon ">
            <i href="{{route('homepage')}}"><img src="{{ asset('backend') }}/img/dosen.jpg" alt=""></i>
        </div>
        <div class="sidebar-brand-text mx-3">Pemilihan Dosen Berprestasi</div>
    </a>
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{route('mobils.index')}}">
            ...
            <span>Data Dosen Berprestasi</span></a>
    </li>
