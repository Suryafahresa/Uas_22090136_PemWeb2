...
<head>
    <meta charset="utf-8">
    <title>Pemilihan Dosen Berprestasi</title>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('frontend') }}/imgs/logo/dosen.jpg">
                ...
                <div class="container">
                    <div class="header-wrap">
                        <div class="logo logo-width-1">
                            <a href="{{route('homepage')}}"><img src="frontend/imgs/logo/dosen.jpg" width="65px" height="60px"
                                    alt="logo"></a>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="widget-about font-md mb-md-5 mb-lg-0">
                                <div class="logo logo-width-1 wow fadeIn animated">
                                    <a href="index.html"><img src="frontend/imgs/logo/dosen.jpg" alt="logo" width="65" height="60"></a>
                                </div>
            ...
            <div class="container pb-20 wow fadeIn animated mob-center">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="text-lg-end text-start font-sm text-muted mb-0">
                            Designed by SurfideMedia Powered By. Namaku Sie
                        </p>
                    </div>
                </div>
            </div>
